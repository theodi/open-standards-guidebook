...
This was the question that triggered Google’s [General Transit Feed Specification](https://developers.google.com/transit/gtfs/reference/) (GTFS) and provided the vision for the standard.  [GTFS Example [pdf]](./open-standards-for-data-canvas-gtfs-example.pdf)
...
**WHY:** Use the WHY section to make the case for the standard – the information here will be useful in building a business case, engaging stakeholders and demonstrating you have done your research on existing standards.  
...
The above description of [GTFS](https://developers.google.com/transit/gtfs/reference/) makes it clear that to deliver public transport information easily, the focus must be on making transit information work together so it’s easy for public transit agencies to supply and developers to use. [GTFS Example [pdf]](./open-standards-for-data-canvas-gtfs-example.pdf)
...
Here, the key reasons why GTFS is the solution to the problem are shared: the public uses navigation products to get directions, so it makes sense to shift the focus here.  [GTFS Example [pdf]](./open-standards-for-data-canvas-gtfs-example.pdf)
...
The GTFS example is explicit about how the key solutions will work: transit agencies will produce feeds that transit developers can consume for a variety of applications and processes. [GTFS Example [pdf]](./open-standards-for-data-canvas-gtfs-example.pdf)

**WHO**: Successful engagement with the right people is essential for a successful open standard for data. Use the WHO section to establish who will be affected by and use the open standard. Say how you expect to communicate with them.
...
For GTFS, there are two main groups to consider besides Google, who are the primary owner, developer and sponsor of the standard. [GTFS Example [pdf]](./open-standards-for-data-canvas-gtfs-example.pdf)
...
The initial GTFS development had two main organisations involved in the alpha or first phase of development. [GTFS Example [pdf]](./open-standards-for-data-canvas-gtfs-example.pdf)
...
GTFS began with workshops (offline) and migrated to Google Groups (online). [GTFS Example [pdf]](./open-standards-for-data-canvas-gtfs-example.pdf)

**HOW**: At this stage, the first six pillars describing the nature of the standard (WHAT), and WHO the standard is aimed at have been completed, leaving the final section – HOW. 
...
For GTFS, this outlines the benefits for key stakeholders as well as the benefit for their key stakeholder – the general public.  [GTFS Example [pdf]](./open-standards-for-data-canvas-gtfs-example.pdf)
...
The above list reflects the key resources for the alpha or first release of GTFS, where Google provided the funding and TriMet Portland the expertise. [GTFS Example [pdf]](./open-standards-for-data-canvas-gtfs-example.pdf)
